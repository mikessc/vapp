...
export default function Page() {
  ...
  return (
    <>
      <div>
        <div className="account-profile-container mx-auto px-8 pt-8 pb-8 max-w-screen-lg box-border  justify">


          <div className="account-profile__content flex flex-col items-center bg-white p-8 shadow-md rounded-md w-full">

            <div className="account-profile__header flex items-center gap-2 mb-4 self-start" style={{ color: '#1B5B8C' }}>
              <Image
            ...
            <div className="base flex flex-col gap-4 w-full">
              ...
              <div className="input-container flex flex-row gap-2 w-full gap-4">
